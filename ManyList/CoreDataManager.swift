...
class CoreDataManager {
    ...
    // initialize coredata class instance
    static let sharedInstance: CoreDataManager = {
        let _sharedInstance = CoreDataManager()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ManyList", withExtension: "momd")!
    ...
    // MARK: coredata saving support functions
